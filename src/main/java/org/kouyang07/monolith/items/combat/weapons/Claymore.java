...
public class Claymore extends MonoItemsIO implements Listener{
    @Getter
    private static final Claymore instance = new Claymore();
    @Getter
    ...
    public ItemStack create(){
        ...
        if(meta != null){
            ...
            AttributeModifier damageModifier = new AttributeModifier(UUID.randomUUID(), "generic.attackDamage", 15.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND);
